...
class p5mTingkat extends CI_controller {
	...
	{	
		...
		$this->load->view('KoordinatorTingkat/layout/Header', $data);
		$this->load->view('KoordinatorTingkat/P5M/P5M_lihat',$data2);
	...
	public function history_lihat()
	{
		...
		$this->load->view('KoordinatorTingkat/History/history_lihat',$data2);
		$this->load->view('KoordinatorTingkat/layout/Footer');		
	}
	...
	public function input()
	{
		...
		$this->load->view('KoordinatorTingkat/layout/Header', $data);
		$this->load->view('KoordinatorTingkat/P5M/P5M_input', $data2);
		$this->load->view('KoordinatorTingkat/layout/Footer');
	}
